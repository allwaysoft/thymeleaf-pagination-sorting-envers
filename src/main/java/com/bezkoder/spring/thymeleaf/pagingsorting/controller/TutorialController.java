...
//        Revisions<Integer, Tutorial> revision = tutorialRepository.findRevisions(1);
//        List<Revision<Integer, Tutorial>> data = revision.getContent();
//        System.out.println(data.get(0).getEntity().getTitle());
//        System.out.println(data.get(0).getMetadata());
//        System.out.println(data.get(0).getRevisionNumber());
        Revisions<Integer, Tutorial> revisions = tutorialRepository.findRevisions(1).reverse();
        for (Revision<Integer, Tutorial> revision : revisions) {
            System.out.println("-----------------------------------------");
